...
public class AutenticacaoIT {
    ...
    public void autenticar_ComCredenciaisValidas_RetornarTokenComStatus200() {
        JwtToken responseBody = testClient
                ...
                .bodyValue(
                        new UsuarioLoginDTO("ana@email.com", "123456")
                )
                .exchange()
                .expectStatus().isOk()
    ...
    public void autenticar_ComCredenciaisInvalidas_RetornarErrorMessageComStatus400() {
        ErrorMessage responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(
                        new UsuarioLoginDTO("invalido@email.com", "123456")
                )
                .exchange()
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(
                        new UsuarioLoginDTO("ana@email.com", "000000")
                )
                .exchange()
                .expectStatus().isBadRequest()
                .expectBody(ErrorMessage.class)
    ...
    public void autenticar_ComUsernameInvalido_RetornarErrorMessageComStatus422() {
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(
                        new UsuarioLoginDTO("@email.com", "123456")
                )
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
    ...
    public void autenticar_ComPasswordInvalido_RetornarErrorMessageComStatus422() {
        ErrorMessage responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(
                        new UsuarioLoginDTO("ana@email.com", "")
                )
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(
                        new UsuarioLoginDTO("ana@email.com", "123")
                )
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
        ...
        responseBody = testClient
                ...
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(
                        new UsuarioLoginDTO("ana@email.com", "123456789")
                )
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
