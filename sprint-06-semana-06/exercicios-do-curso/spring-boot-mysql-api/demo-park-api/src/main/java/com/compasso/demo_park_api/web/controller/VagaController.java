...
import com.compasso.demo_park_api.service.VagaService;
import com.compasso.demo_park_api.web.dto.VagaCreateDTO;
import com.compasso.demo_park_api.web.dto.VagaResponseDTO;
import com.compasso.demo_park_api.web.dto.mapper.VagaMapper;
...
@Tag(name = "Vagas", description = "Contém todas as operações relativas aos recursos para cadastro, edição e leitura de uma vaga.")
...
public class VagaController {
    ...
    @Operation(
            ...
            responses = {
                    ...
                    @ApiResponse(
                            responseCode = "403",
                            description = "Recurso não permitido ao perfil CLIENTE",
                            content = @Content(
                                    mediaType = "application/json;charset=UTF-8",
                                    schema = @Schema(implementation = ErrorMessage.class)
                            )
